...
```json
// .squad/templates/casting/Classic-Sci-Fi-Authors.json
[
    "Asimov",
    "Clarke",
    "Heinlein",
...
You can use anything you like here — fictional characters, mythological figures, or even thematic concepts.  How about characters from your favorite books or movies? Historical inventors? Fantasy heroes? Make it your own!
